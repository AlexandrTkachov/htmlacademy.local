        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$lots[$counter]['picture_url']?>" width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$lots[$counter]['category']?></span>
                    <h3 class="lot__title"><a class="text-link" href="lot.html"><?=$lots[$counter]['name']?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$lots[$counter]['price']?><span class="rub">р</span></span>
                        </div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            while (++$counter<count($categories)) {
                ?>
                <li class="nav__item"><a href="all-lots.html"><?= $categories[$counter]?></a></li>
                <?php
            }
            ?>
        </ul>
